        ...
        <div className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-24">
          <div className="lg:sticky lg:top-24 lg:self-start">
            ...
            <h2
              ...
              className="mt-7 max-w-4xl font-display text-[clamp(4rem,10vw,9.5rem)] font-medium uppercase leading-[0.76] tracking-[-0.06em] text-chrome"
            >
              Tell us
              <br />
              what you
            ...
            <p className="mt-8 max-w-md font-display text-[clamp(1.45rem,2.8vw,2.4rem)] leading-[0.98] tracking-[-0.02em] text-chrome/80 lg:mt-12">
              Looking to buy, sell, rent, or work with Voltaris?
            </p>

            <p className="mt-5 max-w-md font-data text-[0.62rem] uppercase leading-[1.65] tracking-[0.14em] text-steel-muted sm:text-[0.68rem]">
          ...
          <div className="relative lg:pt-3">
            <div className="mb-8 flex items-center justify-between border-b border-hairline pb-5">
              <span className="font-data text-[0.58rem] uppercase tracking-[0.18em] text-steel-muted">
                Start a conversation
              </span>

              <span className="font-data text-[0.58rem] uppercase tracking-[0.18em] text-chrome/35">
                09
              </span>
            </div>
